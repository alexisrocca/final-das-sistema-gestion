...
{
    public partial class FrmProductosBajoStock : Form
    {
        ...
        private void UpdateStock()
        {
            ...
            List<Producto> productos = _productoController.ListarProductosBajoStock(10);
        ...
        public FrmProductosBajoStock(TechStoreDbContext context)
        {
            InitializeComponent();
