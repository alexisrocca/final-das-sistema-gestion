...
namespace FINAL_POO_Sistema_de_Gestion
{
    public partial class FrmModificarCliente : Form
    {
        ...
        public FrmModificarCliente(TechStoreDbContext context)
        {
            InitializeComponent();
        ...
        private void cbCliente_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cliente != null)
            {
                ...
                lblTipoValor.Text = cliente is ClienteMinorista ? "Minorista" : "Mayorista";
            }
            else
            {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string resultado = _clienteController.ModificarCliente(
                    _selectedCliente.Id,
                    txtNombre.Text.Trim(),
        ...
        private void FrmModificarCliente_VisibleChanged(object sender, EventArgs e)
        {
            ClearFields();
