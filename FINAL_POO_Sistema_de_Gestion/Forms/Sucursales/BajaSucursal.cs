...
namespace FINAL_POO_Sistema_de_Gestion
{
    public partial class FrmBajaSucursal : Form
    {
        ...
        public FrmBajaSucursal(TechStoreDbContext context)
        {
            InitializeComponent();
        ...
        private void btnDarDeBaja_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string resultado = _sucursalController.EliminarSucursal(_selectedSucursal.Id);
            ...
            {
                MessageBox.Show($"Error al dar de baja la sucursal: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void FrmBajaSucursal_VisibleChanged(object sender, EventArgs e)
        {
            ClearFields();
